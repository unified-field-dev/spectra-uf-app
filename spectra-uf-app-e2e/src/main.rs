//! Axum + Leptos host for spectra-app SpectraRoutes Playwright.
...
use spectra_uf_app_e2e::seed::seed_data;
use spectra_uf_app_e2e::{
...
async fn serve() -> anyhow::Result<()> {
    ...
    let session_layer = SessionManagerLayer::new(session_store)
        ...
        .with_name("uf_spectra_uf_app_e2e")
        .with_path("/");
    ...
    log::info!("spectra-uf-app-e2e listening on http://{addr}");
